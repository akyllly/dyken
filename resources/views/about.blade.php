...
<head>
    ...
    <link rel="stylesheet" href="{{ secure_asset('css/aboutcss.css') }}">
    ...
    <div class="overview">
      <div class="container">
          <div class="overview_set">
            <div class="overview_title"><h2>About</h2></div>
            <div class="overview_menu">Home/About</div>
          </div>
      </div>
</div>
<div id="promo">
...
<div class="story">
  <div class="container2">
    ...
    <p>A Kazakh company focused on innovation and quality, Dyken designs products and experiences
    ...
    <script type="text/javascript">
        ...
        var myChart = new Chart(ctx,{
            ...
            "data":{
                ...
                "datasets":[{"label":"Progress in years","data":[1000,1500,2500,4000],"backgroundColor":['RGB(68, 184, 172)','RGB(239, 192, 80)','RGB(195, 68, 122)','RGB(247, 202, 201)'],}]},
                "options":{
            }
        });
    </script>
    ...
    <script type="text/javascript">
        ...
        var myChart = new Chart(ctx,{
            ...
            "data":{
                ...
                "datasets":[{"label":"Our consumers","data":[40,30,20,10],"backgroundColor":['RGB(68, 184, 172)','RGB(239, 192, 80)','RGB(195, 68, 122)','RGB(247, 202, 201)'],}]},
                "options":{
            }
        });
    </script>
    ...
    <script type="text/javascript">
        ...
        var myChart = new Chart(ctx,{
            ...
            "data":{
                ...
                "datasets":[{"label":"Our Sales in this year","data":[50,60,60,70,80,90,90],"fill":false,"borderColor":"rgb(75,192,192","lineTension":0.1}]},
                "options":{
            }
        });
    </script>
